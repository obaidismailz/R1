...
import { getDeviceToken, initializePushNotifications, onNotification } from './notifications/push';
...
export default class Root extends React.Component<{}, IState> {
	...
	constructor(props: any) {
		...
		this.state = {
			...
			themePreferences: {
				...
				// darkLevel: 'black'
				currentTheme: supportSystemTheme() ? 'light' : 'light',
				darkLevel: 'light'
			},
			width,
			height,
	...
	componentDidMount() {
		this.listenerTimeout = setTimeout(() => {
			ShareData.getInstance().setFcmToken(getDeviceToken());
	...
	init = async () => {
		...
		ShareData.getInstance().loadShareData();
	};
